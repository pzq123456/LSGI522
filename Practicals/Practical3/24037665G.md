...
| Post-processing GNSS PPP | PPP does not require a reference station, but uses precise orbit and clock correction information to achieve decimeter to centimeter-level positioning accuracy. |
